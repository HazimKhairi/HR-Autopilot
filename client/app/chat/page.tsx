...
export default function HomePage() {
  ...
  const scrollToBottom = () => {
    if (isClient && chatMessagesRef.current) {
    ...
    <div className="min-h-screen bg-[#fafafa]">
      {isClient && isChatOpen && (
        <div className="h-[85vh] flex flex-col">
          {/*chat panel header - converted to top bar*/}
          {/* <div className="flex-shrink-0 border-b border-gray-100 p-4 bg-white shadow-sm">
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            >
              {isSidebarOpen && (
                <>
                  <div className="p-4 flex-shrink-0 border-b border-[#ffebeb]">
                    <div className="mb-2">
                      <div className="flex items-center justify-between">
                    ...
                    <div className="space-y-3">
                      {quickAskOptions.map((option) => (
                        <button
                          ...
                          disabled={isLoading}
                          className={`w-full text-left p-3 rounded-lg bg-white border border-[#ffebeb] transition-all duration-200 group ${isLoading
                            ? 'opacity-50 cursor-not-allowed'
                            : 'hover:border-[#ff6b6b]/30 hover:bg-white'
                            }`}
                        >
                          <div className="flex items-center justify-between">
            ...
            <div className={`flex-1 flex flex-col transition-all duration-300 ${isSidebarOpen ? '' : ''}`}>
                ...
                <div className="space-y-4">
                  {messages.length === 0 ? (
                    <div className="text-center py-12">
                      <div className="w-16 h-16 rounded-full bg-[#fff5f5] border border-[#ffebeb] flex items-center justify-center mx-auto mb-4">
                        <Bot size={24} className="text-[#ff6b6b]" />
                      </div>
                      <h3 className="text-lg font-light text-gray-700 mb-2">Welcome to HR Auto Pilot</h3>
              ...
              {uploadedFiles.length > 0 && (
                <div className="border-t border-gray-100 px-4 pt-3 pb-2 flex-shrink-0 max-h-32 overflow-y-auto">
              ...
              <div className="border-t border-gray-100 p-4 flex-shrink-0">
                <div className="flex items-end gap-3">
                  ...
                  {isLoading ? (
                    <button
                      onClick={handleStop}
                      className="p-3 rounded-full transition-all duration-200 bg-red-500 hover:bg-red-600 shadow-md hover:shadow-lg hover:scale-105"
